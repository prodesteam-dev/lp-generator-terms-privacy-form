...
$from = "pgdanang@piala-partner.com";
...
$re_subject = "お問合せありがとうございます【ソラリス】";
...
if(($confirmDsp == 0 || $sendmail == 1) && $empty_flag != 1){
        ...
        //差出人に届くメールをセット
        if($remail == 1) {
                $userBody = mailToUser($_POST,$dsp_name,$remail_text,$re_date,$re_time,$mailFooterDsp,$mailSignature,$encode);
...
//ユーザ宛送信メールボディ
function mailToUser($arr,$dsp_name,$remail_text,$re_date,$re_time,$mailFooterDsp,$mailSignature,$encode){
        $userBody = '';
        if(isset($arr[$dsp_name])) $userBody = h($arr[$dsp_name]). "様\n";
        // $userBody.= $remail_text;
        $userBody.= '
この度は、「ソラリス」にお問合せいただき誠にありがとうございます。


ご入力いただきました内容を確認のうえ、担当者より改めてご連絡させていただきます。
ご返信まで今しばらくお待ちくださいますようお願い申し上げます。


なお、3営業日以内に弊社からの返信がない場合は、大変お手数ですが再度ご連絡いただくか、
下記電話番号までご一報いただけますと幸いです。
0570-091-710
